...
set(LibIIDM_EXT_CONNECTABLEPOSITION_VERSION 0.2.8)


####### Expanded from @PACKAGE_INIT@ by configure_package_config_file() #######
####### Any changes to this file will be overwritten by the next CMake run ####
####### The input file was libiidm-ext-connectableposition-config.cmake.in                            ########
...
set_and_check(LibIIDM_EXT_CONNECTABLEPOSITION_INCLUDE_DIR "${PACKAGE_PREFIX_DIR}/include")
set_and_check(LibIIDM_EXT_CONNECTABLEPOSITION_LIB_DIR "${PACKAGE_PREFIX_DIR}/lib")

if (WIN32 AND 1)
  set_and_check(LibIIDM_EXT_CONNECTABLEPOSITION_BIN_DIR "${PACKAGE_PREFIX_DIR}/bin")
endif()
